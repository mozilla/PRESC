...
def meanVarianceSpreadPlot(c_sweep, accuracy_parameter_sweep, std_parameter_sweep):
    ...
    '''
    plt.fill_between(c_sweep , np.array(accuracy_parameter_sweep)-np.array(std_parameter_sweep),np.array(accuracy_parameter_sweep) + np.array(std_parameter_sweep) , facecolor = 'xkcd:light pink', alpha=0.7)

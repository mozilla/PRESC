...
def plot_curve(classifiers, X, y, bins = 10):
  ...
  for elem in classifiers: 
    ...
    fraction_of_positives, mean_predicted_value= calibration_curve(y_test, y_pred[:,1], n_bins = bins)
    plt.plot(fraction_of_positives, mean_predicted_value, marker='o', linewidth=1, label=elem[0])

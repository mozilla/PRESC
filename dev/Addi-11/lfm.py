...
def mis_visual(clf,x_train, x_val, x_test,y_train, y_val, y_test):
    ...
    rects1 = plt.bar(index, false_class1, bar_width,alpha=opacity,color='g',label='Class1')

    rects2 = plt.bar(index + bar_width, false_class2, bar_width,alpha=opacity,color='purple',label='Class2')

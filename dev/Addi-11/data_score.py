...
def display_point_type(outliers, point_score, easy_points):
    ...
    counts = [np.count_nonzero(outliers), 
...
def show_point_types(outliers, point_score, easy_points, val=10):
    ...
    print('\nOutliers : \n', outliers[:val],'...')
    print('\nP1 score {:.2f} : \n'.format(point_score['p1'][0]), point_score['p1'][1][:val],'...')
    print('\nP2 score {:.2f} : \n'.format(point_score['p2'][0]), point_score['p2'][1][:val],'...')
    print('\nP3 score {:.2f} : \n'.format(point_score['p3'][0]), point_score['p3'][1][:val],'...')
    print('\nP4 score {:.2f} : \n'.format(point_score['p4'][0]), point_score['p4'][1][:val],'...')
    print('\nP5 score {:.2f} : \n'.format(point_score['p5'][0]), point_score['p5'][1][:val],'...')
